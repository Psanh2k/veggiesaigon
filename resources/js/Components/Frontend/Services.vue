        ...
        <div v-motion :initial="{opacity:0, y:100,}" :visible="{opacity:1, y:0,}"  id="news" class="container mx-auto">
            ...
            <div class="grid lg:grid-cols-4 gap-8">
                <div v-for="post in posts.data" :key="post.id" class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl control-text">
                    ...
                    <div class="mt-5">
                        <a style="float:right" href="./" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">See Detail</a>
                    </div>
                </div>
            </div>
            <div class="mt-5">
                <button style="float:right; width:200px" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">See More...</button>
            </div>
